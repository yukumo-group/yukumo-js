import { V86Emu, REG_ESP } from "./v86.js";
import { reg_read_uint32, reg_write_uint32 } from "./helpers.js";
import { from_bytes_uint32, to_bytes_uint32 } from "./bytes.js";
...
export function ret_n(emu: V86Emu, nbytes: number) {
  const ret_address = pop(emu);
  reg_write_uint32(emu, REG_ESP, reg_read_uint32(emu, REG_ESP) + nbytes);
  jmp(emu, ret_address);
}
